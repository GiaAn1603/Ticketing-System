...
func NewRateLimiter(
	...
	logger := observability.GetLogger("MIDDLEWARE_RATE_LIMIT")
	...
	cb := resiliency.NewCircuitBreaker(logger, "RateLimit_CB", cbMaxReq, cbMinReq, cbFailRatio, cbInterval, cbTimeout)
